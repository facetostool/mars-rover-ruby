...
RSpec.describe BECoding::Direction::West do
  ...
  it 'should return South after spin_left' do
    expect(subject.spin_left.class).to eq(BECoding::Direction::South)
  end

  it 'should return North after spin_right' do
    expect(subject.spin_right.class).to eq(BECoding::Direction::North)
  end
